<%-- 
    Document   : SysAdminDashboard
    Created on : Jun 30, 2025, 12:19:42 PM
    Author     : admin
--%>
    ...
    <body class="  ">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="collapse" href="#dashboard" role="button" aria-expanded="false">
                                ...
                                <span class="item-name">Account control</span>
                                <i class="right-icon">
        ...
        <main class="main-content">
            ...
            <div class="content-inner container-fluid pb-0" id="page_layout">
                ...
                <div>
                    <form action="SysAdminServlet" method="GET">
                        <input type="hidden" name="action" value="pharmacists">
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table class="table border-end border-start align-middle mb-0 rounded">
                                    ...
                                    <!-- No Data Message -->
                                    <c:if test="${empty pharmacistList}">
                                        <tr>
                                            <td colspan="6">
                                                <p class="text-muted mb-0">No managers found.</p>
                                            </td>
                                        </tr>
                                    </c:if>

                                    <!-- Data Rows -->
                                    <c:if test="${not empty pharmacistList}">
                                        <c:forEach var="ph" items="${pharmacistList}" varStatus="loop">
                                            <tr data-item="list">
                                                <th scope="row">${loop.index + 1}</th>
                                                <td>${ph.ID}</td>
                                                <td>
                                                    <h6 class="mb-0 text-body fw-normal">${ph.name}</h6>
                                                </td>
                                                <td>${ph.mobile}</td>
                                                <td>${ph.account_pharmacist_id}</td>
                                                <td>
                                                    <!-- Edit Button -->
                                                    <a class="d-inline-block pe-2" data-bs-toggle="offcanvas"
                                                       href="#offcanvasProductEdit" aria-controls="offcanvasProductEdit">
